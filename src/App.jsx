...
function App() {
  return (
    <>
      <Card mtavari={pizzaImage} name={"Pepperoni Pizza"} ragac={forPizzaImage} text={"Premium pepperoni and cheese is made with real mozzarella on original <br /> hand-tossed crust."} Calories={pizzaCaloriesImage} price={"$23.90"} oldPrice={"$29.90"}/>
